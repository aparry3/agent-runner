...
pnpm --filter @agent-runner/app dev
...
export default async function Home() {
  ...
  const hostedHref = userId ? "/agents" : "/sign-up";
  const hostedLabel = userId ? "Open Workspace" : "Use Hosted Service";
...
pnpm --filter @agent-runner/worker dev
pnpm --filter @agent-runner/app dev`}</CodeBlock>
    </div>
  );
}
